...
def pocketcolony_classes():
    return ['Background', 'EXT_uBF', 'LL', 'LR', 'ART', 'ARB', 'ARFBCL_B_BCL_EXT_BF', 'ALT', 'ALB', 'H_FHR']
...
def cityscapes_palette():
    ...
    return [[128, 64, 128], [244, 35, 232], [70, 70, 70], [102, 102, 156],
            ...
            [0, 0, 230], [119, 11, 32]]
def pocketcolony_palette():
    """Pocektcolony palette for external use."""
    return [[0, 0, 0],
                    [0, 192, 0],
                    [196, 196, 196],
                    [190, 153, 153],
...
def coconeEye_classes():
    # return ['Background', 'L_eyeball_H', 'L_eyelid1_B', 'L_eyelid1_F', 'L_eyelid2_F', 'L_eyelid3_F', 'R_eyeball_H', 'R_eyelid1_B', 'R_eyelid1_F', 'R_eyelid2_F', 'R_eyelid3_F']
    # return ['Background', 'L_eyeball_H', 'L_eyelid1_B', 'L_eyelid', 'R_eyeball_H', 'R_eyelid1_B', 'R_eyelid']
    return ['Background', 'eyeball_H', 'eyelid1_B', 'eyelid_F']
def coconeEye_palette():
    return [[0, 0, 0],       # Background
                    [255, 0, 255],   # L_eyeball
                    [0, 192, 0],     # L_eyelid1
                    # [196, 196, 196], # L_eyelid1
                    # [190, 153, 153], # L_eyelid2
                    [0, 128, 255],   # L_eyelid3
                    # [255, 128, 0],   # R_eyeball
                    # [102, 20, 30],   # R_eyelid1
                    # [128, 64, 255],  # R_eyelid1
                    # [255, 255, 0],   # R_eyelid2
                    # [0, 255, 255],   # R_eyelid3
                    ]
def ade_palette():
...
dataset_aliases = {
    ...
    'isaid': ['isaid', 'iSAID'],
    'stare': ['stare', 'STARE'],
    'pocketcolony' : ['pocketcolony'],
    'coconeEye' : ['coconeEye', 'coconeeye'],
}
