...
import sys
sys.path.append("models/image_inpainting/Palette_diffusion/models")

def init_obj(opt, *args, default_file_name='default file', given_module=None, init_type='Network', **modify_kwargs):
    """
    ...
    # except:
    #     print("==========================")
    #     print(init_type, class_name, file_name)
    #     print("==========================")
